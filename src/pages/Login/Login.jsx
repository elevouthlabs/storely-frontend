      ...
      <div className="w-1/2 mt-[125px] ml-[28px]">
        <form onSubmit={handleLogin} className="w-96 space-y-4">
          <div>
            ...
            <p className="font-Inter font-normal text-[13.6px] leading-6 align-middle text-slate-600">
        ...
        <div className="flex items-center gap-[5px] ml-[140px] mt-[20px]">
          <p className="font-Outfit font-normal text-[18px] leading-[100%] text-center text-black/60">
