        ...
        <div className="min-h-screen bg-gray-100 p-4 md:p-3 lg:p-3">
            <div className="bg-[linear-gradient(107.85deg,#8A2BE2_-14.65%,#4B0082_129.8%)] rounded-2xl p-5 md:p-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 text-white">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="font-Inter max-w-xl text-sm md:text-base text-[#D9D9D9] leading-6">
                ...
                <button className="w-full sm:w-auto h-11 bg-white rounded-lg px-5 font-medium text-[#334155]">
                    Share Link
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
                {/* Revenue Overview */}
                <div className="bg-white rounded-2xl shadow-sm xl:col-span-2">
                    <div className="p-6">
                        ...
                        <div className="flex flex-col items-center justify-center min-h-[260px] text-center text-gray-500">
                            ...
                            <button onClick={() => navigate("/dashboard/product/add-product")} className="mt-4 w-full sm:w-auto bg-purple-600 text-white px-5 py-3 rounded-lg flex items-center justify-center gap-2">
                ...
                <div className="bg-white rounded-2xl shadow-sm">
                    <div className="p-5 md:p-6 space-y-3">
                        ...
                        {[
                            ...
                            <div
                                key={action}
                                className="w-full bg-purple-50 hover:bg-purple-100 p-3 rounded-lg cursor-pointer text-sm font-medium transition-colors"
                            >
                                {action}
                            </div>
                        ))}
