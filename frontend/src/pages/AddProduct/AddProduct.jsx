        ...
        <>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-6">
                ...
                <div className="flex flex-wrap gap-3 w-full lg:w-auto">
                    ...
                    <button onClick={handlePublish} className="w-full sm:w-auto sm:min-w-[164px] h-10 bg-[#4B0082] rounded-[8px] px-4 py-[6px] font-Inter font-medium text-[14px] leading-[20px] text-white text-center" >
                        Publish Products
                    </button>
                </div>
            </div>
                ...
                <div className="xl:col-span-2 space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    className="w-full h-[50px] bg-[#F5F5F5] rounded-[8px] p-[10px] outline-none focus:border focus:border-[#4B0082]"
                                />
                            </div>
                            <div className="flex flex-col gap-1">
                    ...
                    <Card title="Pricing" className="flex h-auto mt-[10px] flex-col gap-3 font-Inter font-medium text-[20px] leading-[20px] text-black align-middle">
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full mt-4 md:col-span-2 xl:col-span-3">
                    ...
                    <Card title="Tags" className="flex h-auto mt-[10px] flex-col gap-3 font-Inter font-medium text-[20px] leading-[20px] text-black align-middle">
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button className="w-full sm:w-auto px-5 h-[50px] border border-[#EFE6FD] rounded-[4px] px-[10px] py-[14px] flex items-center justify-center gap-[10px] font-Poppins font-normal text-[10px] leading-[16px] text-[#2E2E2E] align-middle">Add tags</button>
                        </div>
                    </Card>
                    <Card title="Variants" className="w-full min-h-[185px] bg-white rounded-[12px] p-5">
                        <div>
                            ...
                            <button className="flex item-center justify-center gap-2 font-Inter mt-10 font-medium text-[14px] leading-[24px] tracking-[-0.31px] text-[#28272A] text-center w-full sm:w-auto h-10 border border-[#50525633] rounded-[8px] py-2 px-4"><img src={plus} alt="plus icon" /> Add Options</button>
                        </div>
                    </Card>
                </div>
                <div className="flex flex-col gap-4">
                    <Card title="Product Image" className="w-full min-h-[303px] bg-white rounded-[16px] p-5 ">
                    ...
                    <Card title="Product Status" className="w-full  min-h-[243px] rounded-[16px] p-5 bg-white">
                    ...
                    <Card title="Organization" className="w-full  min-h-[283px] rounded-[16px] p-5 bg-white">
                    ...
                    <Card title="SEO & Metadata" className="w-full  min-h-[283px] rounded-[16px] p-5 bg-white">
                        <div className="flex flex-col gap-3 mt-7">
                            <div className="flex flex-col gap-3">
