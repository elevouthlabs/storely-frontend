        ...
        <div className="mt-6">
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-3">
                    <h1 className=" font-Inter font-medium text-[24px] text-[#1A1A1A] leading-[32px] tracking-[0.07px]">
                        Categories
                    </h1>

                    <p className="font-Inter font-normal text-[16px] text-[#28272A] leading-[24px] tracking-[-0.31px]">
                ...
                <button
                    ...
                    className="bg-[#4B0082] text-white px-4 py-2 rounded-lg font-Inter font-medium text-[16px] leading-[24px] tracking-[-0.31px] text-center"
                >
                    + Add Category
                </button>
            </div>

            <div className="bg-white rounded-xl mt-6 overflow-hidden border">
                ...
                <div className="flex justify-end items-center gap-2 p-4">
                    <button
                        ...
                        className={`border px-3 py-1 rounded ${currentPage === 1
